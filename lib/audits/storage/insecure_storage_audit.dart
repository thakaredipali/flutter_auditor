...
import '../../data/storage_patterns.dart';
import '../../models/audit.dart';
import '../../models/audit_result.dart';
import '../../models/project_context.dart';
import '../../models/security_issue.dart';

class InsecureStorageAudit extends Audit {
  @override
  String get id => 'insecure_storage';

  @override
  String get name => 'Insecure Storage Detection';

  @override
  String get description =>
      'Scans Dart source files for sensitive data stored in plaintext via SharedPreferences or unencrypted Hive boxes.';
  ...
  Future<AuditResult> run(ProjectContext context) async {
    ...
    for (final file in dartFiles) {
      ...
      for (final rule in storagePatterns) {
